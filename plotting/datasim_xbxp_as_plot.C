void datasim_xbxp_as_plot(TString inDat, TString inBac, TString inSim){
	...
	c_xp->Divide(1,2);
	c_xp->cd(1);
	inTreeDat->Draw("tag[nleadindex]->getXp2() >> xp_dat","tag[nleadindex]->getMomentumN().Mag() > 0.3" );
	inTreeBac->Draw("tag[nleadindex]->getXp2() >> xp_bac","tag[nleadindex]->getMomentumN().Mag() > 0.3" );
	inTreeSim->Draw("tag[nleadindex]->getXp2() >> xp_sim","tag[nleadindex]->getMomentumN().Mag() > 0.3" );
	...
	c_xb->Divide(1,2);
	c_xb->cd(1);
	inTreeDat->Draw("eHit->getXb() >> xb_dat","tag[nleadindex]->getMomentumN().Mag() > 0.3");
	inTreeBac->Draw("eHit->getXb() >> xb_bac","tag[nleadindex]->getMomentumN().Mag() > 0.3");
	inTreeSim->Draw("eHit->getXb() >> xb_sim","tag[nleadindex]->getMomentumN().Mag() > 0.3");
	...
	for( int bin = 0 ; bin < nAs_bins ; bin++ ){
		...
		inTreeDat->Draw(Form("tag[nleadindex]->getXp2() >> xp_as_lpt_bins_%i_dat",bin),this_as_cut && lpt && "tag[nleadindex]->getMomentumN().Mag() > 0.3");
		inTreeBac->Draw(Form("tag[nleadindex]->getXp2() >> xp_as_lpt_bins_%i_bac",bin),this_as_cut && lpt && "tag[nleadindex]->getMomentumN().Mag() > 0.3");
		inTreeSim->Draw(Form("tag[nleadindex]->getXp2() >> xp_as_lpt_bins_%i_sim",bin),this_as_cut && lpt && "tag[nleadindex]->getMomentumN().Mag() > 0.3");
		...
		inTreeDat->Draw(Form("tag[nleadindex]->getXp2() >> xp_as_hpt_bins_%i_dat",bin),this_as_cut && hpt && "tag[nleadindex]->getMomentumN().Mag() > 0.3");
		inTreeBac->Draw(Form("tag[nleadindex]->getXp2() >> xp_as_hpt_bins_%i_bac",bin),this_as_cut && hpt && "tag[nleadindex]->getMomentumN().Mag() > 0.3");
		inTreeSim->Draw(Form("tag[nleadindex]->getXp2() >> xp_as_hpt_bins_%i_sim",bin),this_as_cut && hpt && "tag[nleadindex]->getMomentumN().Mag() > 0.3");
