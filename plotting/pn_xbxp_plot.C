void pn_xbxp_plot(TString inDat, TString inBac, TString inSim){
	...
	//c_pn->Divide(2,2);
	c_pn->cd(1);
	inTreeDat->Draw("tag[nleadindex]->getMomentumN().Mag() >> pn_dat","tag[nleadindex]->getMomentumN().Mag() > 0.3");
	inTreeBac->Draw("tag[nleadindex]->getMomentumN().Mag() >> pn_bac","tag[nleadindex]->getMomentumN().Mag() > 0.3");
	inTreeSim->Draw("tag[nleadindex]->getMomentumN().Mag() >> pn_sim","tag[nleadindex]->getMomentumN().Mag() > 0.3");
	...
	for( int bin = 0 ; bin < nXb_bins ; bin++ ){
		...
		inTreeDat->Draw(Form("tag[nleadindex]->getMomentumN().Mag() >> pn_xB_bin_%i_dat",bin),this_xb_cut && "tag[nleadindex]->getMomentumN().Mag() > 0.3 ");
		inTreeBac->Draw(Form("tag[nleadindex]->getMomentumN().Mag() >> pn_xB_bin_%i_bac",bin),this_xb_cut && "tag[nleadindex]->getMomentumN().Mag() > 0.3 ");
		inTreeSim->Draw(Form("tag[nleadindex]->getMomentumN().Mag() >> pn_xB_bin_%i_sim",bin),this_xb_cut && "tag[nleadindex]->getMomentumN().Mag() > 0.3 ");
		//inTreeSim->Draw(Form("tag->getMomentumN().Mag() >> pn_xB_bin_%i_sim12",bin),this_xb_cut && "nHits[nleadindex]->getEdep()/1E4 > 12");
		//inTreeSim->Draw(Form("tag->getMomentumN().Mag() >> pn_xB_bin_%i_sim19",bin),this_xb_cut && "nHits[nleadindex]->getEdep()/1E4 > 19");
	...
	for( int bin = 0 ; bin < nXp_bins ; bin++ ){
		...
		inTreeDat->Draw(Form("tag[nleadindex]->getMomentumN().Mag() >> pn_xP_bin_%i_dat",bin),this_xp_cut && "tag[nleadindex]->getMomentumN().Mag() > 0.3" );
		inTreeBac->Draw(Form("tag[nleadindex]->getMomentumN().Mag() >> pn_xP_bin_%i_bac",bin),this_xp_cut && "tag[nleadindex]->getMomentumN().Mag() > 0.3" );
		inTreeSim->Draw(Form("tag[nleadindex]->getMomentumN().Mag() >> pn_xP_bin_%i_sim",bin),this_xp_cut && "tag[nleadindex]->getMomentumN().Mag() > 0.3" );
		//inTreeSim->Draw(Form("tag->getMomentumN().Mag() >> pn_xP_bin_%i_sim12",bin),this_xp_cut && "nHits[nleadindex]->getEdep()/1E4 > 12");
		//inTreeSim->Draw(Form("tag->getMomentumN().Mag() >> pn_xP_bin_%i_sim19",bin),this_xp_cut && "nHits[nleadindex]->getEdep()/1E4 > 19");
